...
class FeatureName(Enum):
    """Mapping feature variables to data column names."""
...
registry.register_factory(
    FeatureName.CHARACTERS_DENSITY,
    lambda: FeatureGeneratorTakeColumns(
        COL_CHARACTERS_DENSITY,
        normalisation_rule_template=DFTNormalisation.RuleTemplate(
            transformer_factory=SkLearnTransformerFactoryFactory.RobustScaler()
        )
    )
